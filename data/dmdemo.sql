...
INSERT INTO `dm_article` VALUES (2,0,48,1,'','','Test','','<p><img data-dm-content=\"image;c15ktduvvhfoinu52gg0;9\" src=\"../var/images/o/oik/upload-135615037-dsc_2857.jpg\" width=\"269\" height=\"179\" /></p>','','',NULL,NULL,1617742097,1618044684,'c1mci4evvhfo3q8vofcg'),(3,0,5,1,'','','fff','','','','',NULL,NULL,1628163956,1640775019,'c45sut594814ldkkc0t0'),(4,0,1,1,'','','Test','','ff','','',NULL,NULL,1631283443,1631283443,'c4tmhst94811behlf6f0');
...
CREATE TABLE `dm_role` (
  ...
  `under_folder` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `dm_role` VALUES (1,'Anonymous','',1560543095,1560543095,1,'',NULL,0),(2,'Editor','',1560543877,1640735927,1,'edit',NULL,3),(3,'Anonymous','',1572803355,1615413222,1,'anonymous',NULL,0),(7,'Members','',1572803619,1572803619,1,'member',NULL,0),(8,'Administrator','',1602106747,1640736052,1,'admin',NULL,0),(10,'Member','',1627825344,1627825344,1,'member','{\"subject\": 1}',0),(11,'Test','',1627996729,1627996729,1,'member','null',0);
...
INSERT INTO `dm_user_role` VALUES (149,1,8),(150,2,3),(151,3,7),(156,1,10),(157,4,2);
...
-- Dump completed on 2021-12-29 12:46:38
